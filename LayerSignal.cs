...
namespace CompositeVideoOscilloscope {
    ...
    public class LayerSignalI {
        SamplingI iterB, iterF, iterG, iterI, iterM, iterN, iterP;
        ...
        public class LayerSignal {
            ...
            public void Next(LayerSignalI iter) {
                iter.a = iter.b;
            ...
            public LayerSignalI Start(int startX, int startY) =>
                new LayerSignalI {
            ...
            public int Get(LayerSignalI iter) =>
                Get_(iter) << 5;

            public int Get_(LayerSignalI iter) =>
